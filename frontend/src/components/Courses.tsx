  ...
  return (
    <div className="flex-1 p-8 bg-gradient-to-br from-pink-50 to-orange-50">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <h2 className="text-3xl font-bold text-gray-800 mb-4">Cooking Courses</h2>
        <p className="text-gray-600 mb-8">Learn from professional chefs and improve your culinary skills</p>
